# Legacy Edge-Randomization Audit
...
The verified implementation has not generated the archived Cora, CiteSeer, and
PubMed numbers. Those model outcomes remain pending a clean rerun with immutable
per-seed records, matched train/validation/test splits, invariant checksums, and
the structural-statistics audit. Until then, Table XII and Figure 3 remain
