...
\begin{itemize}
    \item \textbf{Type A}: H2GCN improves by +28.1\% on average (exploits 2-hop structure)
    \item \textbf{Type B}: H2GCN improves by only +9.5\% (no 2-hop structure to exploit)
\end{itemize}
