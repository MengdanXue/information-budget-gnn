...
\section{Scoped Aggregation Discriminability Analysis}
\label{sec:snr}

We isolate how a linear aggregation operator changes class-conditional first and second moments. The analysis is exact for the stated conditional-neighbor model, but it is not an information-theoretic error bound or a guarantee for a trained GNN.
