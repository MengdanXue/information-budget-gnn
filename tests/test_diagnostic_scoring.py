...
class DiagnosticScoringTests(unittest.TestCase):
    ...
    def test_manuscript_does_not_present_the_prospective_benchmark_as_completed(self):
        ...
        self.assertIn("has not yet been executed", experiments)
        self.assertIn("no prospective selector headline", experiments)
